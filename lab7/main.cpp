...
private:
    ...
    static const int MOVE_DISTANCE_MERCHANT = 10;
    static const int KILL_DISTANCE_SQUIRREL = 5;
    static const int KILL_DISTANCE_KNIGHT = 10;
    static const int KILL_DISTANCE_MERCHANT = 10;

    set_t array;      // монстры
    set_t survivors;  // выжившие
                ...
                if (npc->is_alive()) {
                    ...
                    switch (npc->getType()) {
                        case ErrantKnightType:
                            ...
                            break;
                        case SlaverType:
                            shift_x = std::rand() % (2 * MOVE_DISTANCE_MERCHANT + 1) - MOVE_DISTANCE_MERCHANT;
                            shift_y = std::rand() % (2 * MOVE_DISTANCE_MERCHANT + 1) - MOVE_DISTANCE_MERCHANT;
                            break;
                        case SquirrelType:
                        ...
                        if (npc->is_alive() && other->is_alive()) {
                            ...
                            switch (npc->getType()) {
                                ...
                                case ErrantKnightType:
                                    ...
                                    break;
                                case SlaverType:
                                    kill_distance = KILL_DISTANCE_MERCHANT;
                                    break;
                            }
                            // определяем силу атаки, бросая 6-ти гранный кубик
